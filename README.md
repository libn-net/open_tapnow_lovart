...
KardoFlow 开源版的 TapNow & Lovart，这俩个都是非常优秀和值得使用的产品，但是有点贵，订阅的形式不够用，还得再补积分，所以，我们开发了这个平替的产品，按量充值，用多少充多少，企业用户可以贴牌代理，普通用户可以自主接入上游便宜稳定的API渠道，支持Windows，Mac安装版，支持云端版、小程序、APP、H5，支持上游短剧订单的接入和分发！
...
##### 如果您是个人创作者，我们给您提供订单和开源的产品，
##### 如果您是创业，包装下再出售，建议贴个牌（价格不贵），我们负责给您上游订单（短剧、广告片、短视频、营销图文、广告素材），产品，培训，售后
##### AI时代产品永远不会有核心竞争力，掌握供应链的供给端和消费端才是核心竞争力，没有团队支撑的 "一人公司" 是少数人割韭菜的工具，大家也擦脸眼睛
...
- ✅ 3、视频卡片：支持Sora2，Veo3，Kling，Hailuo，Minimax等多个优秀模型 
...
#### 1.1.2026 - 预计2026.02.02 发布 (代码发布预计年后3月10号，很多兼容问题需要修复)
- ✅ 1、增加多个模型供应商选比，用户可以选择便宜及稳定的模型供应商，降低成本
- ✅ 2、增加海螺，字节的几个优秀模型支持
- ✅ 3、增加多图编辑和视频编辑的能力
- ✅ 4、增加专业镜头设置，分镜能力，脚本能力
- ✅ 5、增加声音卡片：支持音乐，人声，素材声生成
- ✅ 6、增加软件升级更新能力
- ✅ 7、增加工具能力，支持网络搜索，定向采集，视频拆片等自定义工具能力
- ✅ 8、增加数字人功能，带货等多个场景能力
- ⌛️ 9、开发自定义批量短剧，漫剧等默认工作流能力
- ✅ 10、增加优秀提示词模板，快速生成各种类型吸粉视频


#### 1.2.2603 - 预计2026.03.10 发布(代码预计4月10日发布)
- ⌛️ 1、保障稳定便宜的官方API模型渠道接入，支持非官方渠道的接入，用户按紧急度自由选择渠道，减少成本
- ⌛️ 2、开放已接入的稳定API，供有研发能力的用户自主调用，提供完整的计费和日志能力
- ⌛️ 3、一次性最多生成100个卡片的能力，包括图片，音频，视频等，抽卡概率大提升
- ⌛️ 4、新增Grok Image Video 成人级别内容生成（请遵守当地法律，慎重请勿传播）
- ⌛️ 5、新增资产库能力，包括常用图文、音视频，媒体账号等，支持自定义资产类别和属性，用户资产更丰富
- ⌛️ 6、支持硬件小智的接入，突破物理限制，AI超级流量入口
- ⌛️ 7、支持平台直接发单（短剧、广告片、短视频、营销图文、广告素材），创作者直接接单的能力，保障优秀创作者收益
- ⌛️ 8、支持自定义OEM，域名，品牌，Logo，文案，支付等信息全部自定义


## 产品展示

通过无限画布，用卡片作为结果，用连线作为创意思路，无需复杂的思考和专业技能，简单的连线完成整个创作过程，也可以分享他人，赚取收益（还在扣子挣扎？试试这个）
...
## 我们怎么赚钱的
- 红果等多个分发平台的上游订单，签约的创作者保底分成
- 云端托管版，支持OEM贴牌和代理充值
- 官方/非模型API供应商的一点返利
- TVC广告片，短视频，图文，剧本的一些需求，给到平台创作者
- 自己也会生成优秀的AI短剧、AI漫剧、营销视频，发布到平台，有对应的奖励
- 企业客户的定制集成和研发

#### 内测2周积累了10000多用户，非常感谢群友的支持，我们提供好订单，产品，服务，培训，售后，大家一起赚收益
#### 产品还能够维持研发和运营成本，有些朋友进行了捐赠，谁的钱都不容易，在这里感谢大家
...
## 交流群：备注（Kardo接单，产品试用，贴牌代理，技术交流，产品定制，模型API接入，按需求备注发送）
## 仅作使用和技术交流，请勿发送广告和营销。
